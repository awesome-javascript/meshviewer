    ...
    'nodeInfos': [
      {
        ...
        'image': 'https://multi.meshviewer.org/graph/000000002/node?panelId=1&var-node={NODE_ID}&from=now-86399s&theme=light',
        'title': 'Entwicklung der Anzahl der Clients innerhalb des letzten Tages'
      },
      {
        'name': 'Hardwareauslastung',
        'href': 'https://data.meshviewer.org/d/000000002/node?var-node={NODE_ID}',
        'image': 'https://multi.meshviewer.org/graph/000000002/node?panelId=4&var-node={NODE_ID}&from=now-86399s&theme=light',
    ...
    'linkInfos': [
      {
        ...
        'image': 'https://multi.meshviewer.org/graph/000000002/node?panelId=7&var-node={SOURCE_ID}&var-nodetolink={TARGET_ID}&from=now-86399s&theme=light',
    ...
    'linkTypeInfos': [
      {
        ...
        'image': 'https://multi.meshviewer.org/graph/nvSNqoHmz/link?panelId=8&var-node={SOURCE_ID}&var-nodetolink={TARGET_ID}&var-source_mac={SOURCE_MAC}&var-target_mac={TARGET_MAC}&from=now-86399s&theme=light',
    ...
    'globalInfos': [
      {
        ...
        'image': 'https://multi.meshviewer.org/graph/000000001/global?panelId=1&from=now-7d&theme=light',
